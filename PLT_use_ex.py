...
IMAGES_PATH = r'/Users/vvlrff/Desktop/my_projects/Prosto/static/shift'  # Адрес коллекции изображений
...
IMAGE_SAVE_PATH = r'/Users/vvlrff/Desktop/my_projects/Prosto/static/img/final.jpg'  # Адрес после преобразования изображения
...
def image_compose():
    ...
    for y in range(1, IMAGE_ROW + 1):
        for x in range(1, IMAGE_COLUMN + 1):
            from_image = Image.open(r'/Users/vvlrff/Desktop/my_projects/Prosto/static/shift/' + image_names[IMAGE_COLUMN * (y - 1) + x - 1]).resize(
